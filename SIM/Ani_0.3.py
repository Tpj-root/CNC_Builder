...
amp = 1.0
step = 0.05
base_phase_shift = np.pi / 6  # Max phase shift between motors

# MANUAL CONTROL
wave_factor_value = 0  # <--- change from 0.0 (flat) to 1.0 (full wave)
#wave_factor_value = 0.6  # <--- change from 0.0 (flat) to 1.0 (full wave)
...
def data_gen():
    t = 0
    while True:
        current_phase_shift = base_phase_shift * wave_factor_value
